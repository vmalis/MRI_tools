...
%
% Original version for v12 by Marquette University,   Milwaukee, WI  USA
% Update by Vadim Malis
% March 2016
...
data=zeros(nreceivers,rc_yres,rc_xres);
...
DATA_FFT=fft2(DATA);
f = abs(DATA_FFT);
f = flipdim(rot90(fftshift(f,2)),2);
imtool(mat2gray(f))
